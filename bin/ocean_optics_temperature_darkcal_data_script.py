...
This script was used to sample the dark spectrum on an STS-VIS accross a range
of temperatures and integration times. I sat the VIS on an ice pack and let it
do its work.
