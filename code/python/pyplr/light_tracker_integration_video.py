...
if __name__ == "__main__":
    ...
    mvf.make_video_file('led_test_sinusoid.csv', repeats=5)
    video = 'led_test_sinusoid.dsf'
    ...
    trigger = new_trigger(label_on, duration)
    send_trigger(trigger)    
    sleep(duration)
    trigger = new_trigger(label_off, 0)
    send_trigger(trigger)
    apy.turn_off(device)
