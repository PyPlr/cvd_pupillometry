...
expdir = r"C:\Users\engs2242\Documents\repos\cvd_pupillometry\data\red_vs_blue_2s_pulse_3trials_each"
...
for subjdir in subjdirs:
    ...
    #samples = plr.savgol_series(samples, fields=pupil_cols, window_length=51, filt_order=7, plot=True)
    ...
    fig.savefig(out_dir + '\\pipr_plot.png')
