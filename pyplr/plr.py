...
# def plot_trials(ranges, sample_rate, onset_idx, stim_dur,
#                 pupil_col='diameter', out_dir=None):
...
#         f = plot_plr(
#             df[pupil_col].values, sample_rate, 
#             onset_idx, stim_dur, vel_acc=True, stamp_metrics=True)
#         if out_dir:
